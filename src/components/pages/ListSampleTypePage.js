...
import { ListSampleTypeTemplate } from '../templates';

const apiRoute = 'sampletype';
const getEditRoute = (id = 'new') => `/configuration/sample-type/${id}`;

class ListSampleTypePageComponent extends PureComponent {
  constructor(props) {
    super(props);
...
export const ListSampleTypePage = withSnackbar(ListSampleTypePageComponent);
