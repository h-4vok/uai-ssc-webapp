...
import { ListSiteNewsArticlesTemplate } from '../templates';

const apiRoute = 'sitenews';
const getEditRoute = (id = 'new') => `/marketing/site-news/${id}`;

class ListSiteNewsArticlesPageComponent extends PureComponent {
  constructor(props) {
    super(props);
...
export const ListSiteNewsArticlesPage = withSnackbar(
  ListSiteNewsArticlesPageComponent
);
