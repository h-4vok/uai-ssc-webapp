...
import { ListPatientsTemplate } from '../templates';

const apiRoute = 'patient';
const getEditRoute = (id = 'new') => `/inventory/patient/${id}`;

class ListPatientsPageComponent extends PureComponent {
  constructor(props) {
    super(props);
...
export const ListPatientsPage = withSnackbar(ListPatientsPageComponent);
