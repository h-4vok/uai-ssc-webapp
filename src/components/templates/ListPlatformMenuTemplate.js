...
class ListPlatformMenuTemplateComponent extends PureComponent {
  constructor(props) {
    super(props);
  ...
  buildGridDef = i10n => [
    ...
    {
      headerName: i10n['platform-menu.translation-key'],
      field: 'TranslationKey',
      sortable: true,
      filter: true
    },
    {
      headerName: i10n['platform-menu.menu-order'],
      field: 'MenuOrder',
      sortable: true,
      filter: true
    }
...
export const ListPlatformMenuTemplate = withLocalization(
  withStyles(styles)(ListPlatformMenuTemplateComponent)
);
