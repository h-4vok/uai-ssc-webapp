...
const managementPermission = 'SAMPLE_TYPE_MANAGEMENT';
...
class ListSampleTypeTemplateComponent extends PureComponent {
  constructor(props) {
    super(props);
  ...
  buildGridDef = i10n => [
    ...
    {
      headerName: i10n['global.last-update'],
      field: 'UpdatedDate',
      sortable: true,
      filter: true
    },
    {
      headerName: i10n['global.last-update-by'],
      field: 'UpdatedBy',
      sortable: true,
      filter: true
    }
...
export const ListSampleTypeTemplate = withLocalization(
  withStyles(styles)(ListSampleTypeTemplateComponent)
);
