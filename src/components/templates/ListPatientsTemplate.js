...
const managementPermission = 'PATIENTS_MANAGEMENT';
...
class ListPatientsTemplateComponent extends PureComponent {
  constructor(props) {
    super(props);
  ...
  buildGridDef = i10n => [
    ...
    {
      headerName: i10n['global.name'],
      field: 'Name',
      sortable: true,
      filter: true
    },
    {
      headerName: i10n['model.patient.patient-type'],
      field: 'PatientTypeDescription',
      sortable: true,
      filter: true
    },
    {
      headerName: i10n['model.patient.available-samples'],
      field: 'QuantityOfAvailableSamples',
      sortable: true,
      filter: true
    },
    {
      headerName: i10n['model.patient.used-samples'],
      field: 'QuantityOfUsedSamples',
      sortable: true,
      filter: true
    },
    {
      headerName: i10n['model.patient.total-samples'],
      field: 'TotalOfSamples',
      sortable: true,
      filter: true
    }
  ];
...
export const ListPatientsTemplate = withLocalization(
  withStyles(styles)(ListPatientsTemplateComponent)
);
