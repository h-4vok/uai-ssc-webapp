...
class ListSiteNewsArticlesTemplateComponent extends PureComponent {
  constructor(props) {
    super(props);
  ...
  buildGridDef = i10n => [
    ...
    {
      headerName: i10n['site-news-article.author'],
      field: 'Author',
      sortable: true,
      filter: true
    },
    {
      headerName: i10n['site-news-article.publication-date'],
...
export const ListSiteNewsArticlesTemplate = withLocalization(
  withStyles(styles)(ListSiteNewsArticlesTemplateComponent)
);
