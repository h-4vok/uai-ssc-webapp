...
export const defaultDictionary = {
  ...
  'about-us.text': 'Somos la plataforma de gestión de muestras clínicas y ensayos de investigación número uno del mercado. Nuestro compromiso constante con la calidad y con nuestros clientes nos diferencia en el mercado.',
  ...
  'forgot-password.submit-message': 'Se ha enviado un correo electrónico a la cuenta indicada. Siga los pasos para recuperar su cuenta.',
  'forgot-password.validation.user-not-enabled': 'El usuario se encuentra deshabilitado. Si considera que esto es un error contacte a nuestra Mesa de Ayuda.',
  'forgot-password.validation.user-not-exists': 'El usuario indicado no existe en la plataforma. Verifique el e-mail ingresado',
  ...
  'menu.platform.configuration.sample-type-parameter': 'Parámetros de tipos de muestra',
  ...
  'sign-up--confirm-pending.page.subtitle': 'Hemos enviado por correo electrónico un código de verificación. Utilice el link del correo o coloque el código aquí para finalizar su registro.',
  ...
  'validator.api.min-string-length': 'El campo {0} debe tener al menos {1} caracteres.',
  'validator.api.not-null': 'El campo {0} no puede ser vacío.',
  'validator.api.valid-email-address': 'El campo {0} no es un correo electrónico válido.',
  'validator.ui.email-spec': 'El campo ${propLabel} no cumple con las reglas indicadas.',
  'validator.ui.is-number-spec': 'El campo ${propLabel} debe ser numérico.',
  'validator.ui.mandatory-selection-spec': 'El campo ${propLabel} es obligatorio.',
  'validator.ui.mandatory-string-spec': 'El campo ${propLabel} no puede ser vacio.',
  'validator.ui.password-strength-spec': 'El campo ${propLabel} no cumple con las reglas indicadas.',
  'validator.ui.sign-up--verify-failed': 'No se pudo verificar la cuenta.',
  'validator.ui.sign-up--verify-success': 'Su cuenta ha sido verificada. Puede ahora ingresar a la plataforma Sample Supply Chain.',
  'validator.ui.string-max-length-spec': 'El campo ${propLabel} no puede superar los ${maxLength} caracteres.',
  'validator.ui.string-min-length-spec': 'El campo ${propLabel} debe superar los ${minLength} caracteres.',
  'forgot-password.password-mismatch': 'Las contraseñas no coinciden.',
  'forgot-password.password-reset-success': 'La contraseña ha sido cambiada con éxito.',
  'forgot-password.token-invalid': 'No se pudo validar su pedido de blanquear la contraseña. Por favor, vuelva a intentarlo.',
  ...
  'user-model.create.company-or-role': 'El cliente es obligatorio o el usuario debe ser especificado como usuario de la plataforma.',
  ...
  'contact-us.text': 'A continuación te mostramos las formas de contacto con Sample Supply Chain.',
  'app.marketing.menu.contact-us': 'Contacto',
  'privacy-policy.title': 'Políticas de Privacidad y Seguridad',
  'privacy-policy.text-intro': 'En cumplimiento con lo establecido por la Ley Federal de Transparencia y Acceso a la Información Pública Gubernamental le informamos nuestra política de privacidad y manejo de datos personales y hacemos el siguiente compromiso:',
  'privacy-policy.text-01.txt': 'Reunimos información de carácter no personal, como el tipo de explorador, sistema operativo y página Web visitadas, con el objeto de contribuir a la administración de nuestros sitios Web.',
  'privacy-policy.text-02.txt': 'Utilizamos cookies y otras tecnologías de Internet para administrar nuestro sitio Web y nuestros programas de correo electrónico, pero no para reunir o almacenar información personal.',
  'privacy-policy.text-03.txt': 'Los datos que le solicitamos en los formularios de contacto, red social o cualquier tipo de formulario colocado dentro de nuestro Sitio Web únicamente serán utilizados para  poder establecer contacto con usted en relación a su petición o comentario.',
  'privacy-policy.text-04.txt': 'Los datos que ingrese en cualquiera de los formularios dentro del Sitio Web no serán difundidos, distribuidos o comercializados.',
  'privacy-policy.text-05.txt': 'En caso de que desee ser removido de nuestra base de datos podrá, en cualquier momento, solicitar la baja de la información mediante correo electrónico a admin@ssc.com, o por escrito a la siguiente dirección: Av. Paseo Colón 524, Capital Federal, Argentina.',
  'privacy-policy.text-06.txt': 'Su petición o comentario puede ser incluido dentro de los informes estadísticos que se elaboren para el seguimiento de avances institucionales del Gobierno Federal. No obstante, dichos informes serán meramente estadísticos y no incluirán información que permita identificarle en lo individual. ',
  ...
  'sample-parameter-type.validation.invalid-decimal': 'La cantidad de decimales debe ser mayor a cero.',
  'sample-parameter-type.validation.invalid-ranges': 'El rango mínimo debe ser igual o menor al rango máximo.',
  '"sample-parameter-type.validation.code-exists': 'El código del parámetro ya existe.',
  ...
  'unit-of-measure.validation.code-not-unique': 'El código ingresado ya existe.',
  'global.isenabled': 'Habilitado',
  'configuration.sample-type-parameter.title.edit': 'Editar Tipo de Parámetro de Muestra',
  'configuration.sample-type-parameter.title.new': 'Nuevo Tipo de Parámetro de Muestra',
  ...
  'model.patient.invalid-delete': 'Error al intentar eliminar el paciente indicado.',
  ...
  'sample-type.validation.exists': 'Ya existe un tipo de muestra con este código.',
  'sample-type.validation.used': 'Una o más muestras utilizan el tipo de muestra seleccionado.',
  ...
  'change-password.validation.password-no-match': 'La contraseña actual no coincide. Vuelva a intentarlo.',
  'change-password.validation.empty-passwords': 'Debe llenar todos los campos.',
  'change-password.validation.new-password-no-match': 'Las contraseñas no coinciden.',
  ...
  'product-card.patient-sample-unlimited': 'Sin límite de muestras de pacientes.',
  ...
  'product-compare.grid.row.patient-sample-limit': 'Límite de Muestras de Pacientes',
  'product-compare.grid.row.control-sample-limit': 'Límite de Muestras de Control',
  ...
  'leave-comment.already-done': 'Continuaremos mejorando nuestro servicio para usted.',
  ...
  'platform-menu.validation.need-menu-items': 'Debe especificar al menos un ítem dentro del menú.',
  'platform-menu-item.edit.title': 'Edición de ítem de menú',
  'platform-menu-item.validation.relative-route': 'Debe especificar una ruta relativa para el link del menú.',
  'platform-menu-item.validation.menu-order': 'El orden del item debe ser mayor a 0.',
  'platform-menu-item.validation.translation-key': 'Debe seleccionar una clave de traducción.',
  'platform-menu-item.validation.required-permissions': 'El ítem debe depender de al menos un permiso de la plataforma.',
  ...
  'feedback-form-question.validation.question': 'Debe especificar una pregunta.',
  'feedback-form-question.validation.choices': 'Debe tener al menos 2 opciones.',
  'feedback-form-question.edit.title': 'Pregunta de Ficha de Opinión',
  'feedback-form-question-choice.choice-title': 'Opción',
  'feedback-form-question.validation.empty-choice': 'Una o más opciones están vacías.',
  'feedback-form-question.grid.question': 'Enunciado',
  'submitted-feedback-form.page.title': 'Bienvenido a Sample Supply Chain',
  'submitted-feedback-form.page.subtitle': 'Por favor tómese unos segundos para opinar sobre la experiencia y seguridad del proceso de registración.',
  'submitted-feedback-form.validation.choice-null': 'Una o más preguntas no han sido respondidas.',
  ...
  'send-newsletter.page.subtitle': 'Ingrese las fechas entre las cuales se tomarán las noticias a enviar en el newsletter.',
  ...
  'subscribe-newsletter.subttitle': 'Indique su e-mail para empezar a recibir el newsletter de SSC.',
  ...
  'subscribe-newsletter.email-does-not-exist': 'Usted no se encuentra suscripto.',
  'newsletter-email.subject': 'Newsletter de SSC',
  'newsletter.unsubscribe.success': 'Su suscripción al newsletter ha sido cancelada.',
};